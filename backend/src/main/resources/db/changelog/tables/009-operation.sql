...
CREATE TABLE operation (
    ...
    setup_duration INT NOT NULL DEFAULT 0 CHECK (setup_duration >= 0),
...
COMMENT ON COLUMN operation.duration IS 'Длительность обработки одной единицы детали на операции, минуты';
...
COMMENT ON COLUMN operation.setup_duration IS 'Длительность переналадки станка для начала операции, минуты';
