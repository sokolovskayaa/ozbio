...
record MachineGroupView(String groupId, String name, List<WorkWindowView> workWindows, String setupDuration) {}

record WorkWindowView(String dayLabel, String dayCode, String start, String end) {}
